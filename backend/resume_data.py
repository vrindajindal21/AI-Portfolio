SAMPLE_RESUME = {
    ...
    "education": [
        {
            "degree": "Bachelor of Computer Applications (AI Specialization)",
            "institution": "School of Computer Engineering & Technology, Bennett University, Greater Noida, India",
            "period": "2023-2026",
            "score": "CGPA: 8.82"
        },
        {
            "degree": "Class XII (CBSE)",
            "institution": "S.D Public School, Muzaffarnagar, Uttar Pradesh, India",
            "period": "2023",
    ...
    "skills": {
        "Languages": ["C++", "Python", "Java", "SQL", "HTML/CSS", "C", "JavaScript"],
        "Frameworks": ["Flask", "TensorFlow", "Scikit-learn", "React"],
        "AI": ["Machine Learning", "Deep Learning", "NLP", "Computer Vision"],
        "Technical Skills": ["Data Structures & Algorithms (DSA)", "OOPs", "DBMS", "Operating Systems", "Computer Networks", "Web Development"],
        "Soft Skills": ["Teamwork", "Communication", "Problem-Solving", "Good Listener", "Adaptability"]
    },
    "hobbies": ["Reading", "Traveling", "Exploring AI Trends"],
    "positions_of_responsibility": [
        "Batch Representative (BR), Bennett University",
        "Team leader"
    ]
}
