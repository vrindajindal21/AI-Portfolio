...
async def ask_question(question: str, resume_context: str) -> str:
    ...
    if any(k in q for k in project_keywords):
        ...
        if matching_project and isinstance(matching_project, dict):
            ...
            return (
                ...
                f"*Generated by Vrinda's Logic [v2.1]*"
            )
        ...
        return (
            ...
            f"*Generated by Vrinda's Logic [v2.3]*"
        )
    ...
    if any(k in q for k in ["skill", "tech", "stack", "know", "language", "python", "java", "c++", "ml", "ai", "deep learning", "dl", "nlp", "vision", "dsa", "web"]):
        ...
        return f"Vrinda Jindal possesses strong foundations in: **{skills_str}**. She is proficient in bridging the gap between AI research and production-ready code. [v2.1]"
    ...
    if any(k in q for k in ["hobby", "hobbies", "interest", "fun", "outside", "do for fun"]):
        ...
        return f"Beyond coding, Vrinda Jindal is passionate about: **{h_str}**. She believes in continuous learning! [v2.3]"
